...
<body>
    ...
    <!-- 게시글 관련 버튼 -->
    <button onclick="location.href='reviewlist'">게시판</button>
    <button onclick="location.href='reviewmodify?reviewBoardId=${reviewBoardVO.reviewBoardId}'">게시글 수정</button>
    <button id="deletereviewBoard">게시글 삭제</button>
